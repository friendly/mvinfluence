...
#' @param ref Options to draw reference lines, any one or more of \code{c("h",
#' "v", "d", "c")}.  \code{"h"} and \code{"v"} draw horizontal and vertical
...
#' \code{"c"} draws diagonal reference lines corresponding to approximate 0.95
#' and 0.99 contours of CookD.
#' @param ref.col,ref.lty Color and line type for reference lines.  Reference
#' lines for \code{"c" %in% ref} are handled separately.
#' @param ref.lab A logical, indicating whether the reference lines should be
#' labeled.
